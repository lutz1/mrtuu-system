...
function NavIcon({ name }) {
  switch (name) {
    ...
    case "history":
      return (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4 12a8 8 0 1 1 2.3 5.6" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
...
export default function DispatcherSidebar() {
  const { dispatcherLogout } = useDispatcherAuth();
  ...
  return (
    <aside className={styles.sidebar}>
      ...
      <button type="button" className={styles.logoutBtn} onClick={dispatcherLogout}>
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
