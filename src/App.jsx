...
const VehicleOverviewPage = lazy(() =>
  import("./pages/user/main_page/VehicleOverviewPage")
);
...
const MyBookingsPage = lazy(() =>
  import("./pages/user/main_page/MyBookingsPage")
);
const PaymentMethodsPage = lazy(() =>
  import("./pages/user/account/PaymentMethodsPage")
);
const NotificationsPage = lazy(() =>
  import("./pages/user/account/NotificationsPage")
);
const SignupPage = lazy(() => import("./pages/Login_Signup/SignupPage"));
const BookingDetailsPage = lazy(() =>
  import("./pages/user/main_page/BookingDetailsPage")
);
const PaymentPage = lazy(() => import("./pages/user/main_page/PaymentPage"));
const PaymentSuccessPage = lazy(() =>
  import("./pages/user/main_page/PaymentSuccessPage")
);
const PrivacySecurityPage = lazy(() =>
  import("./pages/user/security/PrivacySecurityPage")
);
const SettingsPage = lazy(() => import("./pages/user/settings/SettingsPage"));
const RequirementsPage = lazy(() =>
  import("./pages/user/requirements/RequirementsPage")
);
...
const AdminBookingsPage = lazy(() =>
  import("./pages/admin/booking/AdminBookingsPage")
);
const AdminVehiclesPage = lazy(() =>
  import("./pages/admin/vehicle/AdminVehiclesPage")
);
const AdminCustomersPage = lazy(() =>
  import("./pages/admin/customer/AdminCustomersPage")
);
const AdminSalesReportsPage = lazy(() =>
  import("./pages/admin/salesReports/AdminSalesReportsPage")
);
...
const AdminNewBookingPage = lazy(() =>
  import("./pages/admin/booking/newBooking/AdminNewBookingPage")
);
const AdminBookingHistoryDetailsPage = lazy(() =>
  import("./pages/admin/booking/history/AdminBookingHistoryDetailsPage")
);
const AdminVehicleDraftsPage = lazy(() =>
  import("./pages/admin/vehicle/drafts/AdminVehicleDraftsPage")
);
const AdminBookingDetailsPage = lazy(() =>
  import("./pages/admin/booking/details/AdminBookingDetailsPage")
);

const DispatcherDashboardPage = lazy(() =>
  import("./pages/dispatcher/dashboard/DispatcherDashboardPage")
);
const DispatcherInspectionPage = lazy(() =>
  import("./pages/dispatcher/inspection/DispatcherInspectionPage")
);
const DispatcherHistoryPage = lazy(() =>
  import("./pages/dispatcher/history/DispatcherHistoryPage")
);
const DispatcherProfilePage = lazy(() =>
  import("./pages/dispatcher/profile/DispatcherProfilePage")
);
const DispatcherInspectionWizardPage = lazy(() =>
